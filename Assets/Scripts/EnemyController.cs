...
public class EnemyController : MonoBehaviour
{
    ...
    [Range(0, 10f)][SerializeField] private float AITime = 1f;

    private IEnumerator Start()
    {
        _current = TowerManager.Instance.GetTile(startTile);
        GameManager.Instance.boolEnemy = true;
        while (GameManager.Instance.boolEnemy && transform !=null)
        {
    ...
    private IEnumerator Animation(Transform target)
    {
        ...
        while (passed < time && transform != null)
        {
